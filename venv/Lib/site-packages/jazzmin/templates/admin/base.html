                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-left" id="jazzy-usermenu">
                        ...
                        {% if perms|can_view_self %}
                            <a href="{% jazzy_admin_url request.user request.current_app|default:"admin" %}" class="dropdown-item dropdown-footer"> <i class="fas fa-user mr-2"></i> {% trans 'See Profile' %}</a>
                        {% endif %}
                        <div class="dropdown-divider"></div>
